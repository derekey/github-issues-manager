...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'IssueEvent', fields ['event']
        db.create_index(u'core_issueevent', ['event'])

        # Adding index on 'IssueEvent', fields ['related_object_id']
        db.create_index(u'core_issueevent', ['related_object_id'])


    def backwards(self, orm):
        # Removing index on 'IssueEvent', fields ['related_object_id']
        db.delete_index(u'core_issueevent', ['related_object_id'])

        # Removing index on 'IssueEvent', fields ['event']
        db.delete_index(u'core_issueevent', ['event'])
