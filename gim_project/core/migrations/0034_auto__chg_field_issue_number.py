...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_issue', 'number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Issue.number'
        db.alter_column(u'core_issue', 'number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
