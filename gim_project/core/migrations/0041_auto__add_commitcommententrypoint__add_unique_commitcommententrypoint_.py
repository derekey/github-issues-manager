...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommitCommentEntryPoint'
        db.create_table(u'core_commitcommententrypoint', (
            ...
            ('commit_sha', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ...
            ('diff_hunk', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commit_comments_entry_points', to=orm['core.Repository'])),
            ('commit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commit_comments_entry_point', null=True, to=orm['core.Commit'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commit_comments_entry_points', null=True, to=orm['core.GithubUser'])),
        ))
        db.send_create_signal(u'core', ['CommitCommentEntryPoint'])

        # Adding unique constraint on 'CommitCommentEntryPoint', fields ['repository', 'commit_sha', 'path', 'position']
        db.create_unique(u'core_commitcommententrypoint', ['repository_id', 'commit_sha', 'path', 'position'])

        # Adding model 'CommitComment'
        db.create_table(u'core_commitcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fetched_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('github_status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, db_index=True)),
            ...
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commit_comments', to=orm['core.Repository'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commit_comments', to=orm['core.GithubUser'])),
            ('commit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commit_comments', null=True, to=orm['core.Commit'])),
            ('commit_sha', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('entry_point', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['core.CommitCommentEntryPoint'])),
        ))
        db.send_create_signal(u'core', ['CommitComment'])

        # Adding M2M table for field linked_commits on 'CommitComment'
        m2m_table_name = db.shorten_name(u'core_commitcomment_linked_commits')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('commitcomment', models.ForeignKey(orm[u'core.commitcomment'], null=False)),
            ('commit', models.ForeignKey(orm[u'core.commit'], null=False))
        ))
        db.create_unique(m2m_table_name, ['commitcomment_id', 'commit_id'])

        # Adding field 'Repository.commit_comments_fetched_at'
        db.add_column(u'core_repository', 'commit_comments_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.commit_comments_etag'
        db.add_column(u'core_repository', 'commit_comments_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.commit_comments_last_page'
        db.add_column(u'core_repository', 'commit_comments_last_page',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'CommitCommentEntryPoint', fields ['repository', 'commit_sha', 'path', 'position']
        db.delete_unique(u'core_commitcommententrypoint', ['repository_id', 'commit_sha', 'path', 'position'])

        # Deleting model 'CommitCommentEntryPoint'
        db.delete_table(u'core_commitcommententrypoint')

        # Deleting model 'CommitComment'
        db.delete_table(u'core_commitcomment')

        # Removing M2M table for field linked_commits on 'CommitComment'
        db.delete_table(db.shorten_name(u'core_commitcomment_linked_commits'))

        # Deleting field 'Repository.commit_comments_fetched_at'
        db.delete_column(u'core_repository', 'commit_comments_fetched_at')

        # Deleting field 'Repository.commit_comments_etag'
        db.delete_column(u'core_repository', 'commit_comments_etag')

        # Deleting field 'Repository.commit_comments_last_page'
        db.delete_column(u'core_repository', 'commit_comments_last_page')
    ...
    models = {
        ...
        u'core.commitcomment': {
            ...
            'commit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commit_comments'", 'null': 'True', 'to': u"orm['core.Commit']"}),
            'commit_sha': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'entry_point': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comments'", 'to': u"orm['core.CommitCommentEntryPoint']"}),
            'fetched_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'repository': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commit_comments'", 'to': u"orm['core.Repository']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commit_comments'", 'to': u"orm['core.GithubUser']"})
        },
        u'core.commitcommententrypoint': {
            'Meta': {'ordering': "('created_at',)", 'unique_together': "(('repository', 'commit_sha', 'path', 'position'),)", 'object_name': 'CommitCommentEntryPoint'},
            'commit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commit_comments_entry_point'", 'null': 'True', 'to': u"orm['core.Commit']"}),
            ...
            'repository': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commit_comments_entry_points'", 'to': u"orm['core.Repository']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'commit_comments_entry_points'", 'null': 'True', 'to': u"orm['core.GithubUser']"})
        },
        u'core.githubuser': {
