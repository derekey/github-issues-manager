...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_userrepository', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_repositories', to=orm['core.GithubUser'])),
    ...
    models = {
        ...
        u'core.githubuser': {
            ...
            'user_repositories_etag': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'user_repositories_fetched_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'core.userrepository': {
            'Meta': {'ordering': "('repository',)", 'unique_together': "(('user', 'repository'),)", 'object_name': 'UserRepository'},
            'fetched_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'github_status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permission': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'repository': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Repository']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_repositories'", 'to': u"orm['core.GithubUser']"})
        }
    }
