...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field watched_repositories on 'GithubUser'
        m2m_table_name = db.shorten_name(u'core_githubuser_watched_repositories')
        ...
        db.create_unique(m2m_table_name, ['githubuser_id', 'repository_id'])

        # Adding M2M table for field starred_repositories on 'GithubUser'
        m2m_table_name = db.shorten_name(u'core_githubuser_starred_repositories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('githubuser', models.ForeignKey(orm[u'core.githubuser'], null=False)),
            ('repository', models.ForeignKey(orm[u'core.repository'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field watched_repositories on 'GithubUser'
        db.delete_table(db.shorten_name(u'core_githubuser_watched_repositories'))

        # Removing M2M table for field starred_repositories on 'GithubUser'
        db.delete_table(db.shorten_name(u'core_githubuser_starred_repositories'))
