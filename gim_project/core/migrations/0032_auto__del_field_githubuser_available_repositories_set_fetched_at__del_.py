...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GithubUser.org_repositories_fetch_data'
        db.delete_column(u'core_githubuser', 'org_repositories_fetch_data')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'GithubUser.org_repositories_fetch_data'
        db.add_column(u'core_githubuser', 'org_repositories_fetch_data',
