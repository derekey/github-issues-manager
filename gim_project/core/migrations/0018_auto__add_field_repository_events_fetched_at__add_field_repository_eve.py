...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.events_fetched_at'
        db.add_column(u'core_repository', 'events_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.events_etag'
        db.add_column(u'core_repository', 'events_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.events_fetched_at'
        db.delete_column(u'core_repository', 'events_fetched_at')

        # Deleting field 'Repository.events_etag'
        db.delete_column(u'core_repository', 'events_etag')
