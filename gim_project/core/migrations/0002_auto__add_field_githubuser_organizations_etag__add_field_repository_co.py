...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GithubUser.organizations_etag'
        db.add_column(u'core_githubuser', 'organizations_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.collaborators_etag'
        db.add_column(u'core_repository', 'collaborators_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.milestones_state_open_etag'
        db.add_column(u'core_repository', 'milestones_state_open_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.milestones_state_closed_etag'
        db.add_column(u'core_repository', 'milestones_state_closed_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.labels_etag'
        db.add_column(u'core_repository', 'labels_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.issues_state_open_etag'
        db.add_column(u'core_repository', 'issues_state_open_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.issues_state_closed_etag'
        db.add_column(u'core_repository', 'issues_state_closed_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.comments_etag'
        db.add_column(u'core_repository', 'comments_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.comments_etag'
        db.add_column(u'core_issue', 'comments_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GithubUser.organizations_etag'
        db.delete_column(u'core_githubuser', 'organizations_etag')

        # Deleting field 'Repository.collaborators_etag'
        db.delete_column(u'core_repository', 'collaborators_etag')

        # Deleting field 'Repository.milestones_state_open_etag'
        db.delete_column(u'core_repository', 'milestones_state_open_etag')

        # Deleting field 'Repository.milestones_state_closed_etag'
        db.delete_column(u'core_repository', 'milestones_state_closed_etag')

        # Deleting field 'Repository.labels_etag'
        db.delete_column(u'core_repository', 'labels_etag')

        # Deleting field 'Repository.issues_state_open_etag'
        db.delete_column(u'core_repository', 'issues_state_open_etag')

        # Deleting field 'Repository.issues_state_closed_etag'
        db.delete_column(u'core_repository', 'issues_state_closed_etag')

        # Deleting field 'Repository.comments_etag'
        db.delete_column(u'core_repository', 'comments_etag')

        # Deleting field 'Issue.comments_etag'
        db.delete_column(u'core_issue', 'comments_etag')
