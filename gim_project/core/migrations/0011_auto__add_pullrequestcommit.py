...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_pullrequestcommit', (
            ...
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pr_commits', to=orm['core.Repository'])),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commits', to=orm['core.Issue'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pr_commits_authored', null=True, to=orm['core.GithubUser'])),
            ('committer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pr_commits__commited', null=True, to=orm['core.GithubUser'])),
            ('sha', self.gf('django.db.models.fields.CharField')(max_length=256, db_index=True)),
            ('message', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('author_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('author_email', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('committer_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('committer_email', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('authored_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('committed_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
        ))
        db.send_create_signal(u'core', ['PullRequestCommit'])

        # Adding field 'Issue.commits_fetched_at'
        db.add_column(u'core_issue', 'commits_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.commits_etag'
        db.add_column(u'core_issue', 'commits_etag',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'core_pullrequestcommit')

        # Deleting field 'Issue.commits_fetched_at'
        db.delete_column(u'core_issue', 'commits_fetched_at')

        # Deleting field 'Issue.commits_etag'
        db.delete_column(u'core_issue', 'commits_etag')
    ...
    models = {
        ...
        u'core.pullrequestcommit': {
            'Meta': {'ordering': "('authored_at',)", 'object_name': 'PullRequestCommit'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pr_commits_authored'", 'null': 'True', 'to': u"orm['core.GithubUser']"}),
            ...
            'authored_at': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'committed_at': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'committer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pr_commits__commited'", 'null': 'True', 'to': u"orm['core.GithubUser']"}),
            ...
            'github_status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commits'", 'to': u"orm['core.Issue']"}),
            'message': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'repository': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pr_commits'", 'to': u"orm['core.Repository']"}),
            'sha': ('django.db.models.fields.CharField', [], {'max_length': '256', 'db_index': 'True'})
        },
        u'core.repository': {
