...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Milestone.created_at'
        db.alter_column(u'core_milestone', 'created_at', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Milestone.number'
        db.alter_column(u'core_milestone', 'number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Milestone.created_at'
        db.alter_column(u'core_milestone', 'created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 28, 0, 0)))

        # Changing field 'Milestone.number'
        db.alter_column(u'core_milestone', 'number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
