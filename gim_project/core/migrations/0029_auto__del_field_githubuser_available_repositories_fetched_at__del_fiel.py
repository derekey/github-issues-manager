...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GithubUser.available_repositories_fetched_at'
        db.delete_column(u'core_githubuser', 'available_repositories_fetched_at')

        # Deleting field 'GithubUser.available_repositories_etag'
        db.delete_column(u'core_githubuser', 'available_repositories_etag')

        # Adding field 'GithubUser.available_repositories_set_fetched_at'
        db.add_column(u'core_githubuser', 'available_repositories_set_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GithubUser.available_repositories_set_etag'
        db.add_column(u'core_githubuser', 'available_repositories_set_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GithubUser.available_repositories_fetched_at'
        db.add_column(u'core_githubuser', 'available_repositories_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'GithubUser.available_repositories_set_fetched_at'
        db.delete_column(u'core_githubuser', 'available_repositories_set_fetched_at')

        # Deleting field 'GithubUser.available_repositories_set_etag'
        db.delete_column(u'core_githubuser', 'available_repositories_set_etag')
