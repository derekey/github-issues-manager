...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AvailableRepository.organization_username'
        db.add_column(u'core_availablerepository', 'organization_username',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AvailableRepository.organization_username'
        db.delete_column(u'core_availablerepository', 'organization_username')
