...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'core_userrepository', ['user_id', 'repository_id'])

        # Deleting model 'UserRepository'
        db.delete_table(u'core_userrepository')

        # Adding model 'AvailableRepository'
        db.create_table(u'core_availablerepository', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='available_repositories_set', to=orm['core.GithubUser'])),
            ...
            ('organization_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['AvailableRepository'])

        # Adding unique constraint on 'AvailableRepository', fields ['user', 'repository']
        db.create_unique(u'core_availablerepository', ['user_id', 'repository_id'])

        # Deleting field 'GithubUser._available_repositories'
        db.delete_column(u'core_githubuser', '_available_repositories')

        # Deleting field 'GithubUser.user_repositories_etag'
        db.delete_column(u'core_githubuser', 'user_repositories_etag')

        # Deleting field 'GithubUser.user_repositories_fetched_at'
        db.delete_column(u'core_githubuser', 'user_repositories_fetched_at')

        # Adding field 'GithubUser.available_repositories_etag'
        db.add_column(u'core_githubuser', 'available_repositories_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'AvailableRepository', fields ['user', 'repository']
        db.delete_unique(u'core_availablerepository', ['user_id', 'repository_id'])

        # Adding model 'UserRepository'
        db.create_table(u'core_userrepository', (
            ('organization_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_repositories_full', to=orm['core.GithubUser'])),
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Repository'])),
            ('fetched_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('permission', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('github_status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, db_index=True)),
        ...
        db.send_create_signal(u'core', ['UserRepository'])

        # Adding unique constraint on 'UserRepository', fields ['user', 'repository']
        db.create_unique(u'core_userrepository', ['user_id', 'repository_id'])

        # Deleting model 'AvailableRepository'
        db.delete_table(u'core_availablerepository')

        # Adding field 'GithubUser._available_repositories'
        db.add_column(u'core_githubuser', '_available_repositories',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GithubUser.user_repositories_etag'
        db.add_column(u'core_githubuser', 'user_repositories_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GithubUser.user_repositories_fetched_at'
        db.add_column(u'core_githubuser', 'user_repositories_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GithubUser.available_repositories_etag'
        db.delete_column(u'core_githubuser', 'available_repositories_etag')
    ...
    models = {
        ...
        u'core.availablerepository': {
            'Meta': {'ordering': "('repository',)", 'unique_together': "(('user', 'repository'),)", 'object_name': 'AvailableRepository'},
        ...
        u'core.githubuser': {
            ...
            'available_repositories_etag': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
