...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_event', (
            ...
            ('related_object_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'events', ['Event'])

        # Adding model 'EventPart'
        db.create_table(u'events_eventpart', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parts', to=orm['events.Event'])),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
            ('old_value', self.gf('jsonfield.fields.JSONField')(default={})),
            ('new_value', self.gf('jsonfield.fields.JSONField')(default={})),
        ))
        db.send_create_signal(u'events', ['EventPart'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EventPart'
        db.delete_table(u'events_eventpart')
    ...
    models = {
        ...
        u'events.eventpart': {
            'Meta': {'object_name': 'EventPart'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parts'", 'to': u"orm['events.Event']"}),
            'field': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_value': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'old_value': ('jsonfield.fields.JSONField', [], {'default': '{}'})
        }
    }
