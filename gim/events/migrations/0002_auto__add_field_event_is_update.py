...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.is_update'
        db.add_column(u'events_event', 'is_update',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'EventPart.old_value'
        db.alter_column(u'events_eventpart', 'old_value', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'EventPart.new_value'
        db.alter_column(u'events_eventpart', 'new_value', self.gf('jsonfield.fields.JSONField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Event.is_update'
        db.delete_column(u'events_event', 'is_update')


        # Changing field 'EventPart.old_value'
        db.alter_column(u'events_eventpart', 'old_value', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'EventPart.new_value'
        db.alter_column(u'events_eventpart', 'new_value', self.gf('jsonfield.fields.JSONField')())
