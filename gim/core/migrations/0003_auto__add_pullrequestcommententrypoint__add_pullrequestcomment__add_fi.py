...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PullRequestCommentEntryPoint'
        db.create_table(u'core_pullrequestcommententrypoint', (
            ...
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pr_comments_entry_points', to=orm['core.Repository'])),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pr_comments_entry_points', to=orm['core.Issue'])),
            ('diff_hunk', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('commit_id', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('original_commit_id', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('original_position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('path', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pr_comments_entry_points', null=True, to=orm['core.GithubUser'])),
        ...
        db.send_create_signal(u'core', ['PullRequestCommentEntryPoint'])

        # Adding model 'PullRequestComment'
        db.create_table(u'core_pullrequestcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fetched_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('github_status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, db_index=True)),
            ('github_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True, blank=True)),
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pr_comments', to=orm['core.Repository'])),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pr_comments', to=orm['core.Issue'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pr_comments', to=orm['core.GithubUser'])),
            ...
            ('entry_point', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['core.PullRequestCommentEntryPoint'])),
        ))
        db.send_create_signal(u'core', ['PullRequestComment'])

        # Adding field 'Repository.pr_comments_fetched_at'
        db.add_column(u'core_repository', 'pr_comments_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.pr_comments_etag'
        db.add_column(u'core_repository', 'pr_comments_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.pr_comments_fetched_at'
        db.add_column(u'core_issue', 'pr_comments_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.pr_comments_etag'
        db.add_column(u'core_issue', 'pr_comments_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PullRequestCommentEntryPoint'
        db.delete_table(u'core_pullrequestcommententrypoint')

        # Deleting model 'PullRequestComment'
        db.delete_table(u'core_pullrequestcomment')

        # Deleting field 'Repository.pr_comments_fetched_at'
        db.delete_column(u'core_repository', 'pr_comments_fetched_at')

        # Deleting field 'Repository.pr_comments_etag'
        db.delete_column(u'core_repository', 'pr_comments_etag')

        # Deleting field 'Issue.pr_comments_fetched_at'
        db.delete_column(u'core_issue', 'pr_comments_fetched_at')

        # Deleting field 'Issue.pr_comments_etag'
        db.delete_column(u'core_issue', 'pr_comments_etag')
