...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.mergeable'
        db.add_column(u'core_issue', 'mergeable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Issue.merged'
        db.add_column(u'core_issue', 'merged',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Issue.nb_commits'
        db.add_column(u'core_issue', 'nb_commits',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.nb_additions'
        db.add_column(u'core_issue', 'nb_additions',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.nb_deletions'
        db.add_column(u'core_issue', 'nb_deletions',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.nb_changed_files'
        db.add_column(u'core_issue', 'nb_changed_files',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding index on 'Issue', fields ['closed_at']
        db.create_index(u'core_issue', ['closed_at'])

        # Adding index on 'Issue', fields ['pr_fetched_at']
        db.create_index(u'core_issue', ['pr_fetched_at'])


    def backwards(self, orm):
        # Removing index on 'Issue', fields ['pr_fetched_at']
        db.delete_index(u'core_issue', ['pr_fetched_at'])

        # Removing index on 'Issue', fields ['closed_at']
        db.delete_index(u'core_issue', ['closed_at'])

        # Deleting field 'Issue.mergeable'
        db.delete_column(u'core_issue', 'mergeable')

        # Deleting field 'Issue.merged'
        db.delete_column(u'core_issue', 'merged')

        # Deleting field 'Issue.nb_commits'
        db.delete_column(u'core_issue', 'nb_commits')

        # Deleting field 'Issue.nb_additions'
        db.delete_column(u'core_issue', 'nb_additions')

        # Deleting field 'Issue.nb_deletions'
        db.delete_column(u'core_issue', 'nb_deletions')

        # Deleting field 'Issue.nb_changed_files'
        db.delete_column(u'core_issue', 'nb_changed_files')
