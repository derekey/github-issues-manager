...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PullRequestCommentEntryPoint', fields ['issue', 'original_commit_sha', 'path', 'original_position']
        db.create_unique(u'core_pullrequestcommententrypoint', ['issue_id', 'original_commit_sha', 'path', 'original_position'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'PullRequestCommentEntryPoint', fields ['issue', 'original_commit_sha', 'path', 'original_position']
        db.delete_unique(u'core_pullrequestcommententrypoint', ['issue_id', 'original_commit_sha', 'path', 'original_position'])
