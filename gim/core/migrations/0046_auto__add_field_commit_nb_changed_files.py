...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commit.nb_changed_files'
        db.add_column(u'core_commit', 'nb_changed_files',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commit.nb_changed_files'
        db.delete_column(u'core_commit', 'nb_changed_files')
