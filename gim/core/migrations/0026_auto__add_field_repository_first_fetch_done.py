...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.first_fetch_done'
        db.add_column(u'core_repository', 'first_fetch_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.first_fetch_done'
        db.delete_column(u'core_repository', 'first_fetch_done')
