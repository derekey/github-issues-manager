...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.prs_fetched_at'
        db.add_column(u'core_repository', 'prs_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.prs_state_open_etag'
        db.add_column(u'core_repository', 'prs_state_open_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.prs_state_closed_etag'
        db.add_column(u'core_repository', 'prs_state_closed_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.base_label'
        db.add_column(u'core_issue', 'base_label',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.base_sha'
        db.add_column(u'core_issue', 'base_sha',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.head_label'
        db.add_column(u'core_issue', 'head_label',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.head_sha'
        db.add_column(u'core_issue', 'head_sha',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.merged_at'
        db.add_column(u'core_issue', 'merged_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.merge_sha'
        db.add_column(u'core_issue', 'merge_sha',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.merged_by'
        db.add_column(u'core_issue', 'merged_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='merged_prs', null=True, to=orm['core.GithubUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.prs_fetched_at'
        db.delete_column(u'core_repository', 'prs_fetched_at')

        # Deleting field 'Repository.prs_state_open_etag'
        db.delete_column(u'core_repository', 'prs_state_open_etag')

        # Deleting field 'Repository.prs_state_closed_etag'
        db.delete_column(u'core_repository', 'prs_state_closed_etag')

        # Deleting field 'Issue.base_label'
        db.delete_column(u'core_issue', 'base_label')

        # Deleting field 'Issue.base_sha'
        db.delete_column(u'core_issue', 'base_sha')

        # Deleting field 'Issue.head_label'
        db.delete_column(u'core_issue', 'head_label')

        # Deleting field 'Issue.head_sha'
        db.delete_column(u'core_issue', 'head_sha')

        # Deleting field 'Issue.merged_at'
        db.delete_column(u'core_issue', 'merged_at')

        # Deleting field 'Issue.merge_sha'
        db.delete_column(u'core_issue', 'merge_sha')

        # Deleting field 'Issue.merged_by'
        db.delete_column(u'core_issue', 'merged_by_id')
    ...
    models = {
        ...
        u'core.issue': {
            ...
            'merge_sha': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
