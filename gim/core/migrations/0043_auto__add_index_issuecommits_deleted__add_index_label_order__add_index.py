...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'IssueCommits', fields ['deleted']
        db.create_index(u'core_issuecommits', ['deleted'])

        # Adding index on 'Label', fields ['order']
        db.create_index(u'core_label', ['order'])

        # Adding index on 'Commit', fields ['deleted']
        db.create_index(u'core_commit', ['deleted'])

        # Adding index on 'PullRequestFile', fields ['path']
        db.create_index(u'core_pullrequestfile', ['path'])


    def backwards(self, orm):
        # Removing index on 'PullRequestFile', fields ['path']
        db.delete_index(u'core_pullrequestfile', ['path'])

        # Removing index on 'Commit', fields ['deleted']
        db.delete_index(u'core_commit', ['deleted'])

        # Removing index on 'Label', fields ['order']
        db.delete_index(u'core_label', ['order'])

        # Removing index on 'IssueCommits', fields ['deleted']
        db.delete_index(u'core_issuecommits', ['deleted'])
    ...
    models = {
        ...
        u'core.issue': {
            ...
            'commits': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'issues'", 'symmetrical': 'False', 'through': u"orm['core.IssueCommits']", 'to': u"orm['core.Commit']"}),
        ...
        u'core.issuecommits': {
            ...
            'commit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'related_commits'", 'to': u"orm['core.Commit']"}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'related_commits'", 'to': u"orm['core.Issue']"})
        },
        u'core.issueevent': {
