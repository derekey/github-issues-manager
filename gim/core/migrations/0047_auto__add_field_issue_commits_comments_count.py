...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.commits_comments_count'
        db.add_column(u'core_issue', 'commits_comments_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.commits_comments_count'
        db.delete_column(u'core_issue', 'commits_comments_count')
