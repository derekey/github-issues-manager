...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.hook_set'
        db.add_column(u'core_repository', 'hook_set',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Repository.hooks_fetched_at'
        db.add_column(u'core_repository', 'hooks_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.hooks_etag'
        db.add_column(u'core_repository', 'hooks_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.hook_set'
        db.delete_column(u'core_repository', 'hook_set')

        # Deleting field 'Repository.hooks_fetched_at'
        db.delete_column(u'core_repository', 'hooks_fetched_at')

        # Deleting field 'Repository.hooks_etag'
        db.delete_column(u'core_repository', 'hooks_etag')
