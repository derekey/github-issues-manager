...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.mergeable_state'
        db.add_column(u'core_issue', 'mergeable_state',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.mergeable_state'
        db.delete_column(u'core_issue', 'mergeable_state')
