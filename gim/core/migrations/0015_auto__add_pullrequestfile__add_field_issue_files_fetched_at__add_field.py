...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PullRequestFile'
        db.create_table(u'core_pullrequestfile', (
            ...
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pr_files', to=orm['core.Repository'])),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['core.Issue'])),
            ...
            ('nb_changes', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('patch', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('tree', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['PullRequestFile'])

        # Adding field 'Issue.files_fetched_at'
        db.add_column(u'core_issue', 'files_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.files_etag'
        db.add_column(u'core_issue', 'files_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PullRequestFile'
        db.delete_table(u'core_pullrequestfile')

        # Deleting field 'Issue.files_fetched_at'
        db.delete_column(u'core_issue', 'files_fetched_at')

        # Deleting field 'Issue.files_etag'
        db.delete_column(u'core_issue', 'files_etag')
    ...
    models = {
        ...
        u'core.pullrequestfile': {
            'Meta': {'ordering': "('path',)", 'object_name': 'PullRequestFile'},
            'fetched_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'github_status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
