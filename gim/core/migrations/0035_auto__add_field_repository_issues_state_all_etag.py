...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.issues_state_all_etag'
        db.add_column(u'core_repository', 'issues_state_all_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.prs_state_all_etag'
        db.add_column(u'core_repository', 'prs_state_all_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.issues_state_all_etag'
        db.delete_column(u'core_repository', 'issues_state_all_etag')

        # Deleting field 'Repository.prs_state_all_etag'
        db.delete_column(u'core_repository', 'prs_state_all_etag')
