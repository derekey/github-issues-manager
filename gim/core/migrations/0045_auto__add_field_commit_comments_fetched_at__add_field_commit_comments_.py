...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commit.commit_comments_fetched_at'
        db.add_column(u'core_commit', 'commit_comments_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Commit.commit_comments_etag'
        db.add_column(u'core_commit', 'commit_comments_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Commit.commit_comments_last_page'
        db.add_column(u'core_commit', 'commit_comments_last_page',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commit.commit_comments_fetched_at'
        db.delete_column(u'core_commit', 'commit_comments_fetched_at')

        # Deleting field 'Commit.commit_comments_etag'
        db.delete_column(u'core_commit', 'commit_comments_etag')

        # Deleting field 'Commit.commit_comments_last_page'
        db.delete_column(u'core_commit', 'commit_comments_last_page')
