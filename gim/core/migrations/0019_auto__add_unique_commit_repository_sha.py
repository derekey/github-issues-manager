...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Commit', fields ['repository', 'sha']
        db.create_unique(u'core_commit', ['repository_id', 'sha'])


    def backwards(self, orm):
        # Removing unique constraint on 'Commit', fields ['repository', 'sha']
        db.delete_unique(u'core_commit', ['repository_id', 'sha'])
