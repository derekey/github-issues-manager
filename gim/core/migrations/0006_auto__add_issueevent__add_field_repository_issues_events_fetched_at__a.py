...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_issueevent', (
            ...
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='issues_events', to=orm['core.Repository'])),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', to=orm['core.Issue'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='issues_events', null=True, to=orm['core.GithubUser'])),
            ('event', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ...
        db.send_create_signal(u'core', ['IssueEvent'])

        # Adding field 'Repository.issues_events_fetched_at'
        db.add_column(u'core_repository', 'issues_events_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.issues_events_etag'
        db.add_column(u'core_repository', 'issues_events_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.events_fetched_at'
        db.add_column(u'core_issue', 'events_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.events_etag'
        db.add_column(u'core_issue', 'events_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'core_issueevent')

        # Deleting field 'Repository.issues_events_fetched_at'
        db.delete_column(u'core_repository', 'issues_events_fetched_at')

        # Deleting field 'Repository.issues_events_etag'
        db.delete_column(u'core_repository', 'issues_events_etag')

        # Deleting field 'Issue.events_fetched_at'
        db.delete_column(u'core_issue', 'events_fetched_at')

        # Deleting field 'Issue.events_etag'
        db.delete_column(u'core_issue', 'events_etag')
    ...
    models = {
        ...
        u'core.issueevent': {
            'Meta': {'ordering': "('created_at',)", 'object_name': 'IssueEvent'},
