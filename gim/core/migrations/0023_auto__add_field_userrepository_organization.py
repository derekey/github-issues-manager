...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserRepository.organization_id'
        db.add_column(u'core_userrepository', 'organization_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserRepository.organization_id'
        db.delete_column(u'core_userrepository', 'organization_id')
    ...
    models = {
        ...
        u'core.githubuser': {
            ...
            'user_repositories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['core.Repository']", 'through': u"orm['core.UserRepository']", 'symmetrical': 'False'}),
        ...
        u'core.userrepository': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_repositories_full'", 'to': u"orm['core.GithubUser']"})
        }
    }
