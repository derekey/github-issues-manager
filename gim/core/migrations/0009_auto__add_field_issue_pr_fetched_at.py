...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.pr_fetched_at'
        db.add_column(u'core_issue', 'pr_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.pr_fetched_at'
        db.delete_column(u'core_issue', 'pr_fetched_at')
    ...
    models = {
        ...
        u'core.issue': {
            ...
            'pr_fetched_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
